    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-menu">
        ...
        {Object.keys(customGroups).length === 0 && (
          <div style={{ padding: "0 1.5rem", fontSize: "0.75rem", color: "var(--sidebar-text)", opacity: 0.7 }}>
            No groups created.
          </div>
        )}
        {Object.keys(customGroups).map(group => (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <span style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: "120px" }}>{group}</span>
            </div>
